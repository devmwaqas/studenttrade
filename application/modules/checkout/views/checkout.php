...
<?php if(ENVIRONMENT == 'development') { ?>
	<script src="https://www.paypal.com/sdk/js?client-id=testclientid&currency=CHF&locale=de_CH"></script>
<?php } else { ?>
	<script src="https://www.paypal.com/sdk/js?client-id=liveclientid&currency=CHF&locale=de_CH"></script>
<?php } ?>
